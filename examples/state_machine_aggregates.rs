...
use cim_domain::{
    ...
    state_machine::{MooreStateTransitions, State, TransitionOutput},
    Component, ComponentExt, DomainComponentSync, DomainEvent,
};
...
async fn demonstrate_state_sync(
    ...
    async fn sync_state(
        ...
        component_sync
            .sync_ddd_to_ecs(door_entity_id, Box::new(component.clone()))
            .await?;
