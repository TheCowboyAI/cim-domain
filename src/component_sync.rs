...
use crate::{infrastructure::nats_client::NatsClient, DomainError, DomainResult};
use cim_component::{
    Component, ComponentEvent, ComponentEventPublisher, ComponentSyncManager, EcsComponentData,
};
...
impl DomainComponentSync {
    ...
    pub async fn sync_ddd_to_ecs(
        ...
        self.sync_manager
            .register_ddd_update(entity_id, component.clone_box())
            .await
    ...
    pub async fn sync_ecs_to_ddd(
        ...
        // Register with sync manager
        self.sync_manager
            .register_ecs_update(entity_id, ecs_data)
            .await
            .map_err(|e| DomainError::ComponentError(e.to_string()))?;
                    ...
                    match event {
                        ...
                        | ComponentEvent::Updated {
                            ...
                            if let Err(e) = sync_manager
                                .register_ecs_update(entity_id, component_data)
                                .await
                            {
